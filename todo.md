...
**Last Updated:** August 10, 2026 (`user-contract` builds and verified end-to-end)
...
**Actually still open, right now:** CI workflows and every other service module still need adding. See the **Still to do** table below.
